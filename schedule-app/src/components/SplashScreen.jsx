  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        ctx.fillStyle = `rgba(61, 122, 92, ${p.alpha})`;
        ctx.fill();
        ...
        for (let j = i + 1; j < Math.min(i + 6, particles.length); j++) {
          ...
          if (distSq < 14400) { // 120^2，避免开方
            ...
            ctx.strokeStyle = `rgba(61, 122, 92, ${0.06 * (1 - dist / 120)})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
    ...
    <div className="splash-screen">
      ...
      <div className="splash-content">
        ...
        <div className={`splash-logo ${phase >= 0 ? 'visible' : ''}`}>
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#3d7a5c" strokeWidth="1.5">
